    ...
    <div className="secondElement">
      < div className="container">
        <div className="secondCon">
          <div className="slogan">YOU <span className="boldText">CREATE,</span> WE <span className="boldText">SUPPORT!</span></div>
            <p className="firstP">크리에이티브 파트너스는 <br/>
            더 큰 꿈을 향해 나아가는 크리에이터와 스타트업의 성공을 위해 <br/>
            세무 회계 서비스를 넘어 재무, 정부지원금, 자금 조달 등 원스톱 경영 컨설팅 서비스를 제공합니다.</p>
            <p className="secondP">축적된 노하우를 바탕으로 회계 세무서비스 시장을 선도하고 있으며,<br/>
